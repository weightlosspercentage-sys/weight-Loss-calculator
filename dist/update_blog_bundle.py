...
BLOG_ENTRIES = [
    ...
    ('weight-loss-plateau', 'Weight Loss Plateau: How to Break Through', 'Science-backed strategies including metabolic adaptation, diet breaks, and 7 proven methods to restart fat loss.', 'Weight Loss', '8 min', 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?auto=format&fit=crop&w=800&q=80'),
    ('weight-loss-percentage-at-100-to-130-lbs', 'Weight Loss Percentage at 100-130 lbs', 'Every pound counts more at lower body weights. Learn what 5%, 10%, and 15% loss means at this range.', 'Weight Loss', '6 min', 'https://images.unsplash.com/photo-1518310383802-640c2de311b2?auto=format&fit=crop&w=800&q=80'),
    ...
    ('weight-loss-percentage-at-230-to-300-lbs', 'Weight Loss Percentage at 230-300 lbs', 'Rapid, safe, life-saving progress. At 250 lbs, 5% loss is 12.5 lbs with profound health improvements.', 'Weight Loss', '7 min', 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?auto=format&fit=crop&w=800&q=80'),
    ...
    ('weight-loss-percentage-chart', 'Weight Loss Percentage Chart: Track Your Milestones', 'Use this month-by-month chart and milestone tracker to gauge your progress accurately.', 'Weight Loss', '5 min', 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80'),
    ...
    ('walking-for-weight-loss', 'Walking for Weight Loss: Steps, Calories, and Consistency', 'The science of steps, calorie burn rates, and joint preservation for all ages.', 'Fitness', '5 min', 'https://images.unsplash.com/photo-1518310383802-640c2de311b2?auto=format&fit=crop&w=800&q=80'),
    ...
    ('water-fasting-weight-loss', 'Water Fasting for Weight Loss: Scientific Truths & Risks', 'What metabolic science says about fat loss, muscle wasting, growth hormone, and safety.', 'Weight Loss', '7 min', 'https://images.unsplash.com/photo-1523362628745-0c100150b504?auto=format&fit=crop&w=800&q=80'),
    ...
    ('peptide-therapy-weight-loss-guide', 'Peptide Therapy for Weight Loss: Science & Safety', 'Beyond FDA-approved medications - the science, safety, and reconstitution dosing.', 'Nutrition', '6 min', 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=800&q=80'),
    ('postpartum-weight-loss-safe-guide', 'Postpartum Weight Loss: Safe Timeline & Lactation', 'Navigate caloric deficits safely while breastfeeding after pregnancy.', 'Weight Loss', '7 min', 'https://images.unsplash.com/photo-1536640712-4d4c36ff0e4e?auto=format&fit=crop&w=800&q=80'),
...
pattern = r'\[\{title:"(?:How to Calculate Weight Loss Percentage|Calorie Deficit for Weight Loss: Complete Guide)[^\]]+\]'
