...
def get_translated_templates():
    ...
    templates = {
        ...
        'description': "Calculate the weight loss percentage from {start} to {target} pounds ({pct}%). Get a customized daily calorie deficit, safe weekly timeline, and health guidance.",
...
def main():
    ...
    for idx, (s, t) in enumerate(combinations):
        ...
        # Select unique intro content for this combination
        ...
        for region in all_regions:
            ...
            # Build unique intro HTML with weight-specific content
