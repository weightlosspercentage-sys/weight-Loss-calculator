...
1. Check credentials: `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run google_auth.py --check --json`
...
### Tier 0 (API Key Only)
- Run PSI + CrUX on homepage: `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run pagespeed_check.py <url> --json`
- Run CrUX History for origin: `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run crux_history.py <origin> --origin --json`
- Report CWV field data with traffic-light ratings

### Tier 1 (+ Service Account)
- All Tier 0 checks
- GSC top queries/pages (28 days): `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run gsc_query.py --property <prop> --json`
...
- URL Inspection on homepage + key pages: `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run gsc_inspect.py <url> --json`
- GSC sitemap status: `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run gsc_query.py sitemaps --property <prop> --json`

### Tier 2 (Full)
- All Tier 1 checks
- GA4 organic traffic (28 days): `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run ga4_report.py --property <id> --json`
- Top organic landing pages: `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run ga4_report.py --property <id> --report top-pages --json`
...
```bash
py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run google_report.py --type full --data data.json --domain DOMAIN --format pdf --json
```
