...
- `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run drift_baseline.py <url>` -- capture a new baseline
- `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run drift_compare.py <url>` -- compare current state to baseline
- `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run drift_history.py <url>` -- show change history
- `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run drift_report.py <file> --output report.html` -- generate HTML report
