...
```bash
py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run dataforseo_costs.py check <endpoint>
```
...
```bash
py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run dataforseo_costs.py log <endpoint> <actual_cost>
```
