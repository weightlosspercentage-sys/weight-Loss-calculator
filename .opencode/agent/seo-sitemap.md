...
1. Discover candidates with `py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run sitemap_discovery.py <url> --json`.
