...
```bash
py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run capture_screenshot.py URL --all --output screenshots/
py -3 "D:\projects\Weight Loss Percentage\Live\Weight Loss Percentage- Upload 1\.agents\skills\seo\scripts\runtime.py" run render_page.py URL --mode auto --a11y-tree --json
```
