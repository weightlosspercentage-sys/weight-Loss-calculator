...
def clean_footer(html_content):
    """Removes any existing language switcher block from the footer, including any extra trailing divs."""
    html_content = re.sub(
...
def inject_language_switcher(html_content, switcher_html):
    pattern = r'(<footer class="static-footer"[^>]*>\s*<div style="max-width: 1200px; margin: 0 auto; text-align: center;">)'
...
def main():
    ...
    for file_path in html_files:
        ...
        for code, info in countries.items():
            ...
            # Base content
            country_content = cleaned_content
