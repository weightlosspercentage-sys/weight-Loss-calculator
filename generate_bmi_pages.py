...
def main():
    ...
    for idx, (h_inches, weight_lbs, ft_str, bmi_val, cat_key, cat_label) in enumerate(combinations):
        ...
        meta_desc = f"Calculate BMI for a person who is {ft_str} tall and weighs {weight_lbs} lbs. BMI = {bmi_display} ({cat_label}). Free dietitian-reviewed BMI calculator and health assessment."
